...
use QuestionnaireBundle\Form\QuestionnaireType;
...
class QuestionnaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('QuestionnaireBundle:Questionnaire')->findAll();
     ...
     * @Method("POST")
     * @Template("QuestionnaireBundle:Questionnaire:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('QuestionnaireBundle:Questionnaire')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("QuestionnaireBundle:Questionnaire:edit.html.twig")
     */
