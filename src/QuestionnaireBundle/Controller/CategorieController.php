...
use QuestionnaireBundle\Entity\Categorie;
use QuestionnaireBundle\Form\CategorieType;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('QuestionnaireBundle:Categorie')->findAll();
     ...
     * @Method("POST")
     * @Template("QuestionnaireBundle:Categorie:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('QuestionnaireBundle:Categorie')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("QuestionnaireBundle:Categorie:edit.html.twig")
     */
